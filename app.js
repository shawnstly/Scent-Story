...
const PRODUCTS = [
    {
      ...
      images: ["images/CEO.png","images/ceo1.png"],
      bestseller: true,
      newLaunch: true
    },
    {
      ...
      images: ["images/Boardroom.png","images/boardroom1.png"],
      bestseller: true
    },
    {
      slug: "fresh-salt-edp",
    ...
    },
    {
      ...
      intensity: "Parfum",
      priceINR: 9780,
      notes: ["Citrus Orange", "Vanilla", "Tobbacco"],
      images: ["images/Intense Romance.png"]
    },
    {
      slug: "victory-night-parfum",
      name: "Victory Night Parfum",
      chapter: "Bold",
      intensity: "Parfum",
      priceINR: 7499,
      notes: ["Incense", "Patchouli", "Grapefruit"],
      images: ["images/Victory Night.png"],
    },
    {
      slug: "tropical-escape-parfum",
      name: "Tropical Escape Parfum",
      chapter: "Carefree",
      intensity: "Parfum",
      priceINR: 7799,
      notes: ["Coconut", "Pineapple", "Jasmine"],
      images: ["images/Tropical Escape.png"],
      newLaunch: true
    },
    {
      slug: "beast-edp",
      ...
      ,images: ["images/Beast.png"]
    },
    {
      slug: "autumn-fire-elixir",
      name: "Autumn Fire Elixir",
      chapter: "Ambition",
      intensity: "Elixir",
      priceINR: 13400,
      notes: ["Clove", "Cedar", "Amber"]
      ,images: ["images/Autumn Fire.png"]
    },
    {
      slug: "winter-embrace-parfum",
      name: "Winter Embrace Parfum",
      chapter: "Ambition",
      intensity: "Parfum",
      priceINR: 7800,
      notes: ["Iris", "Ambergris", "Musk"]
      ,images: ["images/Winter Embrace.png"]
    },
    {
      slug: "first-date-edp",
      name: "First Date EDP",
      ...
      images: ["images/First Date.png"],
    },
    {
      slug: "forever-love-elixir",
      name: "Forever Love Elixir",
      chapter: "Romantic",
      intensity: "Elixir",
      priceINR: 13690,
      notes: ["Rose", "Oud", "Vanilla"],
      images: ["images/Forever Love.png"],
    },
    {
      slug: "summer-drift-edp",
      name: "Summer Drift EDP",
      chapter: "Carefree",
      intensity: "EDP",
      priceINR: 4590,
      notes: ["Citrus", "Sea Breeze", "Musk"],
      images: ["images/Summer Drift.png"],
    },
    {
      slug: "the-icon-parfum",
      name: "The Icon Parfum",
      chapter: "Romantic",
      intensity: "Parfum",
      priceINR: 8780,
      notes: ["Citrus", "Amber", "Musk"],
...
function renderPDP(){
  const rawSlug = (param("slug") || "").toLowerCase();

  // Map short aliases to full slugs (kept in sync with catalog)
  const aliasMap = {
    // Elixir
    'ceo': 'ceo-elixir',
  ...
  const slug = aliasMap[rawSlug] || rawSlug;

  // tolerant finder
  activeProduct = PRODUCTS.find(p => (p.slug||'').toLowerCase() === slug)
               || PRODUCTS.find(p => (p.slug||'').toLowerCase().includes(slug))
               || PRODUCTS.find(p => (p.name||'').toLowerCase() === slug.replace(/-/g,' '));
  window.activeProduct = activeProduct || null;

  if(!activeProduct){
    const root = document.querySelector(".pdp");
    if(root){ root.innerHTML = '<section class="pdp not-found" style="padding:40px 0;color:#cfd6df">Product not found. <a href="index.html#discover">Browse collections</a>.</section>'; }
    return;
  }
